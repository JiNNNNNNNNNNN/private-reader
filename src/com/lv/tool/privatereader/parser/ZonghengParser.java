 ...
 * 纵横中文网解析器
 */
public final class ZonghengParser implements NovelParser {
    private final String url;
    private final HttpClient client;
    private String pageContent;

    public ZonghengParser(final String url) {
        this.url = url;
    ...
    public String getTitle() {
        Pattern pattern = Pattern.compile("<div class=\"book-name\">(.*?)</div>");
    ...
    public String getAuthor() {
        Pattern pattern = Pattern.compile("<div class=\"author-name\".*?>(.*?)</div>");
        Matcher matcher = pattern.matcher(pageContent);
    ...
    public List<Chapter> getChapterList() {
        ...
        while (matcher.find()) {
            ...
            if (!chapterUrl.startsWith("http")) {
                chapterUrl = "https://book.zongheng.com" + chapterUrl;
            }
